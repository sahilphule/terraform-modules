...
resource "azurerm_container_app_environment" "container-app-environment" {
  ...
  infrastructure_resource_group_name = var.container-app-setup-properties.ca-environment.infrastructure-resource-group-name
  infrastructure_subnet_id           = var.vnet-infrastructure-subnet-id
